% AUTOMATICKY GENEROVÁNO: import_fsae_excel_to_matlab.m (v2)
% Datum importu: 07.04.2026 11:21:36
% Zdroj: FSAE_Pushrod_Parametry.xlsx
% ----------------------------------------------------------------

% AUTOMATICKY GENEROVÁNO skriptem import_fsae_excel_to_matlab.m
% Datum importu: 01.04.2026 23:23:29
% Zdroj parametrů: FSAE_Pushrod_Parametry.xlsx
% ----------------------------------------------------------------

% AUTOMATICKY GENEROVÁNO skriptem import_fsae_excel_to_matlab.m
% Datum importu: 01.04.2026 23:10:09
% Zdroj parametrů: FSAE_Pushrod_Parametry.xlsx
% ----------------------------------------------------------------
% AUTOMATICKY GENEROVÁNO skriptem import_fsae_excel_to_matlab.m
% Datum importu: 01.04.2026 14:52:02
% Zdroj parametrů: FSAE_Pushrod_Parametry.xlsx
% ----------------------------------------------------------------
% -------------------------------------------------------------------
...
Vehicle.Chassis.Body.sAxle2.Value = [-1.53, 0, 0];
...
Vehicle.Chassis.SuspA1.Linkage.LowerWishbone.sInboardF.Value = [0.06624, 0.16783, 0.11957];
...
Vehicle.Chassis.SuspA1.Linkage.LowerWishbone.sInboardR.Value = [-0.11, 0.1882, 0.11957];
...
Vehicle.Chassis.SuspA1.Linkage.LowerWishbone.sOutboard.Value = [-0.008, 0.58015, 0.15789];
...
Vehicle.Chassis.SuspA1.Linkage.UpperWishbone.sInboardF.Value = [0.056, 0.256, 0.24857];
...
Vehicle.Chassis.SuspA1.Linkage.UpperWishbone.sInboardR.Value = [-0.12769, 0.26199, 0.22857];
...
Vehicle.Chassis.SuspA1.Linkage.UpperWishbone.sOutboard.Value = [-0.03, 0.56626, 0.31677];
...
Vehicle.Chassis.SuspA1.Linkage.Upright.sCG.Value = [-0.01428, 0.58973, 0.22513];
...
Vehicle.Chassis.SuspA1.Linkage.Upright.sWheelCentre.Value = [0, 0.619, 0.23323];
...
Vehicle.Chassis.SuspA1.Linkage.TrackRod.sInboard.Value = [0.0905, 0.179, 0.11927];
...
Vehicle.Chassis.SuspA1.Linkage.TrackRod.sOutboard.Value = [0.038, 0.59246, 0.15639];
...
Vehicle.Chassis.SuspA1.Linkage.Shock.sTop.Value = [0.1702, 0.15, 0.4];
...
Vehicle.Chassis.SuspA1.Linkage.Shock.sBottom.Comments = ...
  'Must be consistent with values in Spring, Damper';
Vehicle.Chassis.SuspA1.Linkage.Shock.sBottom.Value = [-0.01342, 0.15827, 0.4];
...
Vehicle.Chassis.SuspA1.Linkage.Shock.mCylinder.Value = 4.31577;
...
Vehicle.Chassis.SuspA1.Linkage.Pushrod.sLowerArm.Value = [-0.029, 0.5475, 0.17];
...
Vehicle.Chassis.SuspA1.Linkage.Pushrod.sBellcrank.Value = [-0.07, 0.25406, 0.4];
...
Vehicle.Chassis.SuspA1.Linkage.Bellcrank.sPivot.Value = [-0.015, 0.25, 0.4];
...
Vehicle.Chassis.SuspA1.Linkage.Bellcrank.sAntiRollBar.Value = [-0.0143, 0.16591, 0.35];
...
Vehicle.Chassis.SuspA1.AntiRollBar.sSuspension.Value = [-0.0143, 0.16591, 0.35];
...
Vehicle.Chassis.SuspA1.AntiRollBar.sOutboard.Value = [0.14255, 0.162, 0.34];
...
Vehicle.Chassis.SuspA1.AntiRollBar.sInboard.Value = [0.126, 0.1595, 0.28];
...
Vehicle.Chassis.SuspA1.AntiRollBar.sMount.Value = [0.126, 0.08, 0.28];
...
Vehicle.Chassis.SuspA1.Steer.Rack.sMount.Value = [0.0905, 0, 0.11927];
...
Vehicle.Chassis.SuspA1.Steer.Wheel.sMount.Value = [-0.56, 0, 0.47];
...
Vehicle.Chassis.SuspA1.Steer.Pinion.sMount.Value = [0.07787, 0, 0.10644];
...
Vehicle.Chassis.SuspA2.Linkage.LowerWishbone.sInboardF.Value = [0.23712, 0.2245, 0.12457];
...
Vehicle.Chassis.SuspA2.Linkage.LowerWishbone.sInboardR.Value = [-0.027, 0.09975, 0.10507];
...
Vehicle.Chassis.SuspA2.Linkage.LowerWishbone.sOutboard.Value = [-0.0005, 0.5255, 0.13123];
...
Vehicle.Chassis.SuspA2.Linkage.UpperWishbone.sInboardF.Value = [0.23599, 0.2247, 0.25557];
...
Vehicle.Chassis.SuspA2.Linkage.UpperWishbone.sInboardR.Value = [0.03421, 0.182, 0.22907];
...
Vehicle.Chassis.SuspA2.Linkage.UpperWishbone.sOutboard.Value = [0.03549, 0.4915, 0.32773];
...
Vehicle.Chassis.SuspA2.Linkage.Upright.sCG.Value = [0 0.53919 0.23323];
...
Vehicle.Chassis.SuspA2.Linkage.Upright.sWheelCentre.Value = [0, 0.575, 0.23323];
...
Vehicle.Chassis.SuspA2.Linkage.TrackRod.sInboard.Comments = ...
  'Must  be consistent with steering rack outboard point';
Vehicle.Chassis.SuspA2.Linkage.TrackRod.sInboard.Value = [0.01782, 0.24518, 0.24814];
...
Vehicle.Chassis.SuspA2.Linkage.TrackRod.sOutboard.Value = [-0.052, 0.4986, 0.32373];
...
Vehicle.Chassis.SuspA2.Linkage.TrackRod.m.Value = 0.3;
...
Vehicle.Chassis.SuspA2.Linkage.Shock.sTop.Comments = ...
  'Must be consistent with values in Spring, Damper';
Vehicle.Chassis.SuspA2.Linkage.Shock.sTop.Value = [0.22999, 0.227, 0.4];
...
Vehicle.Chassis.SuspA2.Linkage.Shock.sBottom.Comments = ...
  'Must be consistent with values in Spring, Damper';
Vehicle.Chassis.SuspA2.Linkage.Shock.sBottom.Value = [0.05975, 0.26723, 0.4];
...
Vehicle.Chassis.SuspA2.Linkage.Shock.mCylinder.Value = 4.31577;
...
Vehicle.Chassis.SuspA2.Linkage.Pushrod.sLowerArm.Value = [0.0433, 0.4726, 0.14];
...
Vehicle.Chassis.SuspA2.Linkage.Pushrod.sBellcrank.Value = [0.002915, 0.19967, 0.4];
...
Vehicle.Chassis.SuspA2.Linkage.Bellcrank.sPivot.Value = [-0.0292, 0.192, 0.4];
...
Vehicle.Chassis.SuspA2.Linkage.Bellcrank.sAntiRollBar.Comments = ...
  'Must be same as AntiRollBar.sSuspension';
Vehicle.Chassis.SuspA2.Linkage.Bellcrank.sAntiRollBar.Value = [-0.0531, 0.2467, 0.35];
...
Vehicle.Chassis.SuspA2.AntiRollBar.sSuspension.Comments = ...
  'Must be same as Linkage.Bellcrank.sAntiRollBar';
Vehicle.Chassis.SuspA2.AntiRollBar.sSuspension.Value = [-0.0531, 0.2467, 0.35];
...
Vehicle.Chassis.SuspA2.AntiRollBar.sOutboard.Value = [-0.1191, 0.218, 0.34];
...
Vehicle.Chassis.SuspA2.AntiRollBar.sInboard.Value = [-0.1122, 0.21687, 0.4];
...
Vehicle.Chassis.SuspA2.AntiRollBar.sMount.Value = [-0.1122, 0.11, 0.4];
...
Vehicle.Chassis.SuspA2.AntiRollBar.m.Value = 1.5;
...
Vehicle.Chassis.Aero.sPressureCentre.Value = [-0.8, 0, 0.6];
...
Vehicle.Chassis.Damper.Axle1.Endstop.KxMax.Value = 1e+06;
...
Vehicle.Chassis.Damper.Axle1.Endstop.KxMin.Value = 1e+06;
...
Vehicle.Chassis.TireA1.Inertia.Value = [1, 2];
...
Vehicle.Chassis.TireA2.Inertia.Value = [1 2];
...
Vehicle.Powertrain.Power.MotorL2.TorqueSpd.trq.Value = [200 200 200 200 190.9859 143.2394 114.5916 95.493 81.8511 71.6197 63.662 57.2958 52.0871 47.7465];
...
Vehicle.Powertrain.Power.MotorL1.TorqueSpd.w.Value = [0 1666.6667 3333.3333 4774.6371 5000 6666.6667 8333.3333 10000 11666.6667 13333.3333 15000 16666.6667 18333.3333 20000];
1666,6667
3333,3333
4774,6371
5000
...
Vehicle.Powertrain.Power.MotorL1.TorqueSpd.trq.Value = [300 300 300 300 286.4789 214.8592 171.8873 143.2394 122.7767 107.4296 95.493 85.9437 78.1306 71.6197];
